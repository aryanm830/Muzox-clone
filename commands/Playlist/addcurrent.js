...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        await db.updateOne({ UserId: message.author.id, PlaylistName: Name }, { $push: { songs: { title: song.title, uri: song.uri, author: song.author, duration: song.duration } } });
